 ...
 * 黑暗模式配色
 */
public final class DarkColorsConfigure extends BaseColorsConfigure {
    ...
    private static final int UP_BACKGROUND = 0xff1d2e2b;// 涨的颜色
    private static final int LOW_BACKGROUND = 0xff2f1e1f;// 跌的颜色
    private static final int FLAT_BACKGROUND = 0xff333333;// 不涨不跌的颜色
